...
const MAP_TYPE = ['maybe', 'forof', 'either']
...
const createFunctor = (another, data, mapFn) => {
   const functor = Object.create(functorProto)
   functor[VALUE] = data

   const pipeline = (another[PIPELINE] || []).slice(0)
   pipeline.push(mapFn)
